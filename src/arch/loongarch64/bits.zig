...
pub const Register = enum(u8) {
    ...
    pub const zero = @This().r0;
    pub const ra = @This().r1;
    pub const tp = @This().r2;
    pub const sp = @This().r3;
    pub const fp = @This().r22;
    ...
    pub fn id(reg: Register) u6 {
        ...
        const base: u6 = switch (@intFromEnum(reg)) {
        ...
        return @as(u6, @intCast(reg.enc())) + base;
    }
